...
function Hero() {
  return (
    <div className=' overflow-hidden py-24 xl:py-44 2xl:py-52 lg:py-36 md:py-28 relative  flex items-center'>
       ...
       <img className=' absolute min-w-full min-h-full  left-0 -top-96  max-w-3xl' src="/hero.png" alt="" />
       </div>
    </div>
  )
}
